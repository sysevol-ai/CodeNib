...
"""Run the pinned CodeNib Base native-LSP agent ablation."""
...
from codenib.eval.agent_runner.live_lsp_provider import LiveLSPReferenceProvider
from codenib.graph.code_graph import CodeGraph
from codenib.graph.incremental.lsp_client import LSPClient
from codenib.llm.litellm_chat import LiteLLMChat
from codenib.ls_index.index_quality import TRANSLATION_UNIT_SUFFIXES
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        sys.stderr.write(f"codenib-lsp-agent-study-run: {exc}\n")
        return 1
