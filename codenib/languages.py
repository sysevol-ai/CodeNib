...
LANGUAGE_SPECS: Tuple[LanguageSpec, ...] = (
    LanguageSpec(
        ...
        chunker_class="codenib.code_chunking.python_chunker:PythonCodeChunker",
        ...
        graph_indexer="codenib.scip_interface.scip_indexer_python:SCIPPythonIndexer",
        graph_decoder="codenib.scip_interface.scip_decode_python:SCIPPythonGraphDecoder",
        ...
        incremental_patcher="codenib.graph.incremental.patcher_python:PatcherPython",
        lsp_language_id="python",
        lsp_command=("basedpyright-langserver", "--stdio"),
        lsp_command_env="CODENIB_PYTHON_LSP_CMD",
        core_decoder=True,
    ),
    LanguageSpec(
        key="go",
        ...
        chunker_class="codenib.code_chunking.go_chunker:GoCodeChunker",
        chunk_extensions=(".go",),
        gt_language="go",
        gt_extensions=(".go",),
        graph_language="go",
        ...
        cold_start_backend="scip",
        graph_indexer="codenib.scip_interface.scip_indexer_go:SCIPGoIndexer",
        graph_decoder="codenib.scip_interface.scip_decode_go:SCIPGoGraphDecoder",
        scip_cold_start=ScipColdStartOption(
            tool="scip-go",
            status="active",
            command=("scip-go",),
        ...
        incremental_backend="lsp",
        incremental_patcher="codenib.graph.incremental.patcher_go:PatcherGo",
        lsp_language_id="go",
    ...
    LanguageSpec(
        ...
        chunker_class="codenib.code_chunking.rust_chunker:RustCodeChunker",
        chunk_extensions=(".rs",),
        gt_language="rust",
        gt_extensions=(".rs",),
        graph_language="rust",
        ...
        cold_start_backend="scip",
        graph_indexer="codenib.scip_interface.scip_indexer_rust:SCIPRustIndexer",
        graph_decoder="codenib.scip_interface.scip_decode_rust:SCIPRustGraphDecoder",
        scip_cold_start=ScipColdStartOption(
        ...
        incremental_backend="lsp",
        incremental_patcher="codenib.graph.incremental.patcher_rust:PatcherRust",
        lsp_language_id="rust",
        lsp_command_factory="codenib.scip_interface.rust_analyzer:rust_analyzer_command",
        core_decoder=True,
    ),
    LanguageSpec(
        key="cpp",
        ...
        chunker_aliases=("cpp", "c++", "cxx", "cc"),
        chunker_class="codenib.code_chunking.cpp_chunker:CppCodeChunker",
        chunk_extensions=(".cpp", ".cxx", ".cc", ".c", ".hpp", ".h", ".hxx"),
        gt_language="cpp",
        gt_extensions=(".c", ".cpp", ".cc", ".cxx", ".h", ".hpp"),
        graph_language="cpp",
        graph_aliases=("cpp", "c++", "c", "cc"),
        ...
        graph_indexer="codenib.ls_index.clangd_indexer:ClangdIndexer",
        graph_decoder="codenib.ls_index.clangd_decode:ClangdGraphDecoder",
        incremental_backend="clangd",
        incremental_patcher="codenib.graph.incremental.patcher_cpp:PatcherCpp",
        lsp_language_id="cpp",
        lsp_command=("clangd",),
    ),
    LanguageSpec(
        ...
        chunker_class="codenib.code_chunking.csharp_chunker:CSharpCodeChunker",
        chunk_extensions=(".cs",),
        gt_language="csharp",
        gt_extensions=(".cs",),
        ...
        cold_start_backend="scip",
        graph_indexer="codenib.scip_interface.scip_indexer_csharp:SCIPCSharpIndexer",
        graph_decoder="codenib.scip_interface.scip_decode_csharp:SCIPCSharpGraphDecoder",
        scip_cold_start=ScipColdStartOption(
            tool="scip-dotnet",
            status="active",
            command=("scip-dotnet",),
            command_env="CODENIB_CSHARP_SCIP_CMD",
            note=(
                "Primary C# cold-start backend after generated and real-repo "
                "csharp-ls alignment gates; use graph_route='lsp' for csharp-ls."
            ),
        ),
        scip_candidate_indexer="codenib.scip_interface.scip_indexer_csharp:SCIPCSharpIndexer",
        lsp_language_id="csharp",
        lsp_command=("csharp-ls",),
        lsp_command_env="CODENIB_CSHARP_LSP_CMD",
    ),
    LanguageSpec(
        key="java",
        display_name="Java",
        ...
        chunker_class="codenib.code_chunking.java_chunker:JavaCodeChunker",
        ...
        cold_start_backend="scip",
        graph_indexer="codenib.scip_interface.scip_indexer_java:SCIPJavaIndexer",
        graph_decoder="codenib.scip_interface.scip_decode_java:SCIPJavaGraphDecoder",
        scip_cold_start=ScipColdStartOption(
            tool="scip-java",
            status="active",
            command=("scip-java", "index"),
            command_env="CODENIB_JAVA_SCIP_CMD",
            note=(
                "Primary Java cold-start backend after generated and real-repo "
                "JDT LS alignment gates; use graph_route='lsp' for JDT LS."
            ),
        ),
        scip_candidate_indexer="codenib.scip_interface.scip_indexer_java:SCIPJavaIndexer",
        lsp_language_id="java",
        lsp_command=("jdtls",),
        lsp_command_env="CODENIB_JAVA_LSP_CMD",
    ),
    LanguageSpec(
        key="ruby",
        display_name="Ruby",
        ...
        chunker_class="codenib.code_chunking.ruby_chunker:RubyCodeChunker",
        chunk_extensions=(".rb",),
        gt_language="ruby",
        gt_extensions=(".rb",),
        graph_language="ruby",
        ...
        cold_start_backend="scip",
        graph_indexer="codenib.scip_interface.scip_indexer_ruby:RubyHybridIndexer",
        graph_decoder="codenib.scip_interface.scip_decode_ruby:SCIPRubyGraphDecoder",
        scip_cold_start=ScipColdStartOption(
            tool="scip-ruby",
            status="active",
            command=("bundle", "exec", "scip-ruby"),
            command_env="CODENIB_RUBY_SCIP_CMD",
            note=(
        ...
        scip_candidate_indexer="codenib.scip_interface.scip_indexer_ruby:SCIPRubyIndexer",
        lsp_language_id="ruby",
        lsp_command=("ruby-lsp",),
        lsp_command_env="CODENIB_RUBY_LSP_CMD",
        core_decoder=True,
    ...
    LanguageSpec(
        ...
        chunker_aliases=("php",),
        chunker_class="codenib.code_chunking.php_chunker:PhpCodeChunker",
        ...
        cold_start_backend="scip",
        graph_indexer="codenib.scip_interface.scip_indexer_php:PHPHybridIndexer",
        graph_decoder="codenib.scip_interface.scip_decode_php:SCIPPHPGraphDecoder",
        scip_cold_start=ScipColdStartOption(
            tool="scip-php",
            status="active",
            command=("vendor/bin/scip-php",),
            command_env="CODENIB_PHP_SCIP_CMD",
            note=(
        ...
        scip_candidate_indexer="codenib.scip_interface.scip_indexer_php:SCIPPHPIndexer",
        lsp_language_id="php",
        lsp_command=("intelephense", "--stdio"),
        lsp_command_env="CODENIB_PHP_LSP_CMD",
    ),
    LanguageSpec(
        key="kotlin",
        display_name="Kotlin",
        ...
        chunker_class="codenib.code_chunking.kotlin_chunker:KotlinCodeChunker",
        ...
        cold_start_backend="scip",
        graph_indexer="codenib.scip_interface.scip_indexer_java:SCIPKotlinIndexer",
        graph_decoder="codenib.scip_interface.scip_decode_java:SCIPKotlinGraphDecoder",
        scip_cold_start=ScipColdStartOption(
            tool="scip-java",
            status="active",
            command=("scip-java", "index"),
            command_env="CODENIB_KOTLIN_SCIP_CMD",
            note=(
        ...
        scip_candidate_indexer="codenib.scip_interface.scip_indexer_java:SCIPKotlinIndexer",
        lsp_language_id="kotlin",
        lsp_command=("kotlin-language-server", "--stdio"),
        lsp_command_env="CODENIB_KOTLIN_LSP_CMD",
    ),
    LanguageSpec(
        key="swift",
        display_name="Swift",
        ...
        chunker_class="codenib.code_chunking.swift_chunker:SwiftCodeChunker",
    ...
    LanguageSpec(
        ...
        chunker_class="codenib.code_chunking.scala_chunker:ScalaCodeChunker",
        ...
        cold_start_backend="scip",
        graph_indexer="codenib.scip_interface.scip_indexer_java:SCIPScalaIndexer",
        graph_decoder="codenib.scip_interface.scip_decode_java:SCIPJavaGraphDecoder",
        scip_cold_start=ScipColdStartOption(
            tool="scip-java",
            status="active",
            command=("scip-java", "index"),
            command_env="CODENIB_SCALA_SCIP_CMD",
            note=(
        ...
        scip_candidate_indexer="codenib.scip_interface.scip_indexer_java:SCIPScalaIndexer",
    ),
    LanguageSpec(
        key="lua",
        display_name="Lua",
        ...
        chunker_class="codenib.code_chunking.lua_chunker:LuaCodeChunker",
    ...
    LanguageSpec(
        ...
        chunker_class="codenib.code_chunking.js_chunker:JsTsCodeChunker",
        ...
        cold_start_backend="scip",
        graph_indexer="codenib.scip_interface.scip_indexer_ts:SCIPTypeScriptIndexer",
        graph_decoder="codenib.scip_interface.scip_decode_ts:SCIPTypeScriptGraphDecoder",
        scip_cold_start=ScipColdStartOption(
        ...
        incremental_backend="lsp",
        incremental_patcher="codenib.graph.incremental.patcher_ts:PatcherTS",
