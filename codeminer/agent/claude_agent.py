...
class ClaudeLocAgent:
    ...
    def __init__(
        ...
        self.system_prompt = system_prompt or (
            ...
            "- Each symbol object must have:\n"
            "  - \"name\": fully-qualified symbol name using the language's standard "
            "convention. Do NOT abbreviate or omit enclosing scopes. "
            "For functions and methods, include trailing \"()\" "
            "(e.g. use \"Foo::bar()\" not \"Foo::bar(int x)\"). "
            "For classes/structs/fields, do NOT add \"()\". "
            "Be consistent across all symbols.\n"
            "  - \"type\": symbol type (function/class/method/field)\n"
            "  - \"file_path\": relative to repo root\n"
            "  - \"line_start\": start line number\n"
            "  - \"line_end\": end line number\n"
            "  - \"action\": what needs to be done (modify/add/delete)\n"
            "  - \"description\": brief description of why change is needed\n"
