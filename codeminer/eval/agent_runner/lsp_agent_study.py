...
"""Dynamic native-LSP arms for the CodeMiner Base agent ablation."""
...
from codeminer.agent.runner import LOCALIZATION_SCHEMA
...
class LSPAgentStudySpec:
    """Pre-registered controls for the CodeMiner Base provider ablation."""
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "primary_comparison": [CODEMINER_LSP_ARM, LIVE_LSP_ARM],
...
class LSPAgentStudyTask:
    """One CodeMiner Base task and its scoring labels."""
...
def study_arm_order(
    ...
    rep: int,
    *,
    seed: str = "codeminer-lsp-agent-v1",
