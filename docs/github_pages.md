...
excerpts are reread from the captured source. Typed SVG diagrams are rendered
...
provenance and published file hashes. Source citations contain their excerpts;
