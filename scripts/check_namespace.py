...
# These resources have not been republished under new owners. They are data
# addresses, not supported package, command, environment, or state aliases.
_EXTERNAL_IDENTITY_PATTERNS = (
    re.compile(rf"sysevol-ai/{_FORMER_CAMEL}(?=$|[/#?\s)`'\",.;:])"),
